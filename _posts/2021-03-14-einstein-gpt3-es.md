---
layout: post
title:  "Entrevistando a Albert Einstein a través de GPT-3"
lang: "es"
comments: true
---
<figure>
  <figcaption style="text-align: left">
  Resumen: utilicé GPT-3 para generar una entrevista de fantasía con Albert Einstein.
  </figcaption>
</figure>
<img style="min-height: auto;" class="cover" src="/img/einstein-gpt3/cover.png">

He estado jugando intermitentemente con GPT-3 desde su lanzamiento, porque es una tecnología genial. Uno de los usos más interesantes que he encontrado es hablar con famosos muertos. A continuación, se muestra un ejemplo de **una conversación con Albert Einstein**. Avíseme si leería un libro electrónico corto con 10 entrevistas similares con personajes históricos, estoy pensando en escribirlo si hay suficientes personas interesadas.

Todo el texto en **negrita** fue mi propia entrada, y el resto fue generado por la IA como una respuesta plausible. ¡Espero que lo disfrutes tanto como yo!

<br /> 
**La siguiente es una transcripción de una conversación entre Manuel Araoz, un informático argentino de 31 años, y Albert Einstein. Albert Einstein fue un físico teórico nacido en Alemania que desarrolló la teoría de la relatividad, uno de los dos pilares de la física moderna (junto con la mecánica cuántica). Su trabajo también es conocido por su influencia en la filosofía de la ciencia. Es mejor conocido por el público en general por su fórmula de equivalencia masa-energía E = mc2, que ha sido apodada "la ecuación más famosa del mundo". Recibió el Premio Nobel de Física en 1921 "por sus servicios a la física teórica, y especialmente por su descubrimiento de la ley del efecto fotoeléctrico", un paso fundamental en el desarrollo de la teoría cuántica.**
